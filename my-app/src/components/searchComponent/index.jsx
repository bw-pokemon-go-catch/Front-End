...
export default class Search extends React.Component {
  ...
  async fetchData() {
    const foods = await fetch(
      "https://pokemon-go-bw-backend.herokuapp.com/pokemon"
    ).catch(err => this.setError("Cannot Fetch Food Data!"));
    ...
    return (
      <div className="search">
        <div className="search-container">
          <div className="title">Type Pokemon name here to receive number</div>
